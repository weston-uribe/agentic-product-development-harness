...
**Still deferred:** Additional skills beyond issue intake. See [`docs/skills/skill-architecture.md`](docs/skills/skill-architecture.md) for planned architecture concepts.
