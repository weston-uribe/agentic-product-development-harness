...
Generic examples aligned with [`gpt/issue-intake/knowledge.md`](../../gpt/issue-intake/knowledge.md). Validator fixtures in `tests/fixtures/issues/` may use operator-specific allowlist repos.
